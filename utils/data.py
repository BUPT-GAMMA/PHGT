...
def dataset_config(args):
    if args.dataset == 'DBLP':
        ...
        # args.n_in_dict = {'0': 334, '1': 4230, '2': 50, '3': 20}  # DBLP type 0
        args.n_in_dict = {'0': 4057, '1': 14328, '2': 7723, '3': 20}  # DBLP type 3
        # args.n_in_dict = {'0': 14328, '1': 14328, '2': 14328, '3': 14328}  # DBLP type 3 + padding
        # args.n_in_dict = {'0': 14348, '1': 14348, '2': 14348, '3': 14348}  # DBLP type 3 + HDE + padding
        # args.n_in_dict = {'0': 20, '1': 20, '2': 20, '3': 20}  # DBLP type hde
        # args.n_in_dict = {'0': 4077, '1': 14348, '2': 7743, '3': 40}  # DBLP type 3 + HDE
...
def model_config(args):
    hetero_models = ['HGT', 'HAN']
    homo_models = ['GIN', 'GCN', 'SAGE']

    if args.model in hetero_models:
        args.is_hetero = True
        args.hete_or_homo = 'hete'
    elif args.model in homo_models:
        args.is_hetero = False
        args.hete_or_homo = 'homo'
    else:
